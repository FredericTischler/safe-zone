...
class JwtUtilTest {
    ...
    @Test
    void validateToken_shouldReturnTrueWhenEmailMatches() {
    ...
    @Test
    void validateToken_shouldReturnFalseWhenEmailDiffers() {
        String token = buildToken("seller@mail.com");

        assertThat(jwtUtil.validateToken(token, "other@mail.com")).isFalse();
    }
